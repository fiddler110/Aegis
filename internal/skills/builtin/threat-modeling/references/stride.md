...
3. **For each applicable (element, category) pair**, decide: does a
   ...
   category with its mitigation and residual risk — don't just omit covered
   cells.
...
|---|---|---|---|---|---|---|
| T1 | <element> | Spoofing | <description> | <control, or "none — open finding"> | <what remains after mitigation> | <critical/high/medium/low> |
