...
func (t *adviseTool) Execute(ctx context.Context, input json.RawMessage) (tool.Result, error) {
	...
	case "cve_lookup":
		records, err := security.LookupCVE(ctx, security.CVEOptions{CVEID: args.CVEID, Keyword: args.Keyword, Limit: args.Limit})
		if err != nil {
