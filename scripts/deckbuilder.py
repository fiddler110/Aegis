...
BUILT_IN_THEMES: dict[str, dict] = {
     "Corp_red": {
        "primary":    "#ED1C24",   # ctcred      — main CTC red
        "dark":       "#231F20",   # ctcdark     — near-black body text
        "navy":       "#243558",   # deepened ctcdarkblue for dark slide bgs
        "blue":       "#3A517C",   # ctcdarkblue — card / badge accent
        "teal":       "#009863",   # ctcgreen    — positive / delivered
        "green":      "#009863",   # ctcgreen
        "orange":     "#D47F4C",   # ctcorange   — caution / medium risk
        "light_gray": "#F5F5F5",   # lightgrey   — card backgrounds
        "mid_gray":   "#646464",   # ctcgrey     — footer / subtitle text
        "white":      "#FFFFFF",
    },
    "corporate_red": {
        "primary":    "#CE1126",
...
def build(deck_def: dict, *, output_override: str = None, theme_override: str = None,
    ...
    _DEFAULT_LOGO = Path(__file__).parent / "assets" / "CantireLogo.png"
    logo_path = None
