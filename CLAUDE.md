...
| `internal/persona` | 20 built-in named system prompts (general, security, developer, SRE, red-team, security-critic/security-arbiter debate roles, etc.); custom personas are `.md` files with YAML frontmatter, hot-reloaded via a signature-cached `Refresh` |
