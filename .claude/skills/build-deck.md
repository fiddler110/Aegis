...
3. **Write the YAML** — follow the schema exactly. Default theme is `Corp_red` unless the user specifies otherwise.
...
meta:
  ...
  theme: Corp_red                    # see theme list below
  logo: "assets/logo.png"            # optional; Corp_red uses this automatically if present
...
|--------------------|----------------|---------------------------------------|
| `Corp_red`         | `#ED1C24`      | Default — bold red accent             |
