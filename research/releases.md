...
*Branch note:* this worktree's `research/roadmap.md`/`research/releases.md` were based on an older
commit that predates the rest of the 2026-07-13 STRIDE-A threat-model batch (P27.1-P27.15, P27.17,
P27.18), which landed via a separate parallel line of work not reflected below — reconcile against
that history when merging.
